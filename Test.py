...
#     if args.model == 'cnn' and args.dataset == 'cifar':
#         torch.save(net_D,'./save_net/discriminator/Dmodel_cifar.pkl')
#         torch.save(net_C,'./save_net/classifer/Cmodel_cifar.pkl')
#         torch.save(net_G,'./save_net/generator/Gmodel_cifar.pkl')
...
#         torch.save(net_D,'./save_net/discriminator/')
#         torch.save(net_C,'./save_net/classifer/')
#         torch.save(net_G,'./save_net/generator/')

#     elif args.dataset == 'svhn':
#         torch.save(net_D,'./save_net/discriminator/Dmodel_svhn.pkl')
#         torch.save(net_C,'./save_net/classifer/Cmodel_svhn.pkl')
#         torch.save(net_G,'./save_net/generator/Gmodel_svhn.pkl')


#     elif args.model == 'mlp':
#         torch.save(net_D,'./save_net/discriminator/Dmodel_mlp.pkl')
